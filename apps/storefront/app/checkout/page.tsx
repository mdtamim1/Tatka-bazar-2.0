...
function CheckoutContent() {
  ...
  // When Pre-order is enabled, Cash on Delivery (COD) is strictly turned OFF
  useEffect(() => {
  ...
  const handleFinalOrder = async () => {
    if (isPreOrder && paymentMethod === "COD") {
      alert(
        locale === "bn"
          ? "প্রি-অর্ডারের ক্ষেত্রে ক্যাশ অন ডেলিভারি বন্ধ। অনুগ্রহ করে বিকাশ বা নগদ নির্বাচন করুন।"
          : "Cash on Delivery is unavailable for pre-orders. Please select bKash or Nagad."
      );
      return;
    }
                  ...
                  <div className="pt-3 border-t border-border space-y-3">
                    ...
                    {isPreOrder && (
                      <div className="p-4 bg-muted/20 border border-border space-y-4 animate-in fade-in-50 duration-200">
                        ...
                        {/* Notice: COD disabled for pre-order */}
                        <div className="p-3 bg-amber-500/10 border border-amber-500/25 flex items-start gap-2.5 text-xs text-amber-800 dark:text-amber-300">
                          <Info className="w-4 h-4 text-amber-600 dark:text-amber-400 shrink-0 mt-0.5" />
                          <div>
                            <p className="font-semibold">
                              {locale === "bn"
                                ? "প্রি-অর্ডারে ক্যাশ অন ডেলিভারি অফ থাকবে"
                                : "Cash on Delivery is Turned Off for Pre-orders"}
                            </p>
                            <p className="text-[11px] opacity-90 mt-0.5">
                              {locale === "bn"
                                ? "শিডিউল অনুযায়ী নিশ্চিত ডেলিভারির জন্য প্রি-অর্ডার পেমেন্ট শুধুমাত্র বিকাশ বা নগদ দিয়ে করতে হবে।"
                                : "To guarantee scheduled cold-chain delivery, pre-orders must be paid via bKash or Nagad."}
                            </p>
                          </div>
                        </div>
                      </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      const isCodDisabled = isPreOrder && isCod;
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            "p-4 border transition-all flex items-center justify-between",
                            isCodDisabled
                              ? "opacity-45 bg-muted/20 border-dashed border-border/80 cursor-not-allowed select-none"
                              : paymentMethod === m.id
                        ...
                        >
                          <div className="flex-1 pr-3">
                            <div className="flex items-center gap-2 flex-wrap">
                              ...
                              {isCodDisabled && (
                                <span className="text-[10px] font-sans font-semibold tracking-wider uppercase px-2 py-0.5 bg-rose-500/10 text-rose-600 dark:text-rose-400 border border-rose-500/20">
                                  {locale === "bn" ? "অফ (OFF)" : "OFF"}
                                </span>
                              )}
                            </div>
                            <p
                              className={cn(
                                "text-xs mt-0.5",
                                isCodDisabled
                                  ? "text-rose-600/90 dark:text-rose-400 font-medium"
                                  : "text-muted-foreground"
                              )}
                            >
                              {isCodDisabled
                                ? locale === "bn"
                                  ? "⚠️ প্রি-অর্ডারে ক্যাশ অন ডেলিভারি অফ থাকবে। শুধুমাত্র বিকাশ বা নগদ পেমেন্ট গ্রহণযোগ্য।"
                                  : "⚠️ Cash on Delivery is turned off for pre-orders. Online payment only."
                                : m.desc}
                            </p>
                          </div>
                          <div
