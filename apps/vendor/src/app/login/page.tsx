    ...
    <>
      ...
      >
        ...
        >
          ...
          <button type="button" className="login-social-btn" onClick={() => alert("শীঘ্রই আসছে...")} title="Google দিয়ে লগইন">
          ...
          <button type="button" className="login-social-btn" onClick={() => alert("শীঘ্রই আসছে...")} title="Apple দিয়ে লগইন" style={{ marginBottom: 0 }}>
