    ...
    <>
      ...
      <div style={{
        ...
        <div style={{
          ...
          boxShadow: "0 32px 80px rgba(0,0,0,.7), 0 0 0 1px rgba(255,255,255,.04), inset 0 1px 0 rgba(255,255,255,.06)",
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 28 }}>
            <button
              type="button"
              onClick={() => {
                if (step === "password") { setStep("identifier"); setError(""); }
          ...
          <div style={{ textAlign: "center", marginBottom: 32 }}>
            ...
            <h1 style={{ fontSize: "1.75rem", fontWeight: 900, color: "#F0F6FF", letterSpacing: "-0.5px", margin: "0 0 6px" }}>
              লগইন করুন
            </h1>
            <p style={{ fontSize: ".85rem", color: "rgba(168,192,216,.7)", margin: 0, fontFamily: "var(--font-bn)" }}>
          ...
          {step === "identifier" ? (
            <form onSubmit={handleNext}>
              ...
              <div style={{
                ...
                <button type="button" className={`login-tab ${tab === "phone" ? "active" : ""}`}
                  onClick={() => { setTab("phone"); setIdentifier(""); setError(""); }}>
                  📱 মোবাইল
                </button>
                <button type="button" className={`login-tab ${tab === "email" ? "active" : ""}`}
                  onClick={() => { setTab("email"); setIdentifier(""); setError(""); }}>
                  ✉️ ইমেইল
                </button>
              </div>

              <div style={{ marginBottom: 18 }}>
                <label style={{ display: "block", fontSize: ".78rem", fontWeight: 600, color: "rgba(168,192,216,.8)", marginBottom: 8, fontFamily: "var(--font-bn)" }}>
                ...
                <input
                  ...
                  placeholder={tab === "phone" ? "017XXXXXXXX" : "example@email.com"}
                  value={identifier}
              ...
              <button id="auth-next-btn" type="submit" className="login-btn-primary">
                পরবর্তী →
              </button>
            </form>
          ) : (
            <form onSubmit={handleLoginSubmit}>
              ...
              <div style={{
                ...
                <span style={{ fontWeight: 600, color: "#F0F6FF", fontSize: ".9rem" }}>{identifier}</span>
                <button
                  type="button"
                  onClick={() => { setStep("identifier"); setError(""); }}
                  style={{ background: "none", border: "none", color: "#FF6B2B", fontSize: ".82rem", fontWeight: 700, cursor: "pointer", fontFamily: "var(--font-bn)" }}
                >
                  পরিবর্তন করুন
                </button>
              </div>
                ...
                <div style={{ position: "relative" }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: "rgba(168,192,216,.5)", padding: 0,
                    }}
                  >
                    {showPassword ? (
              ...
              <button id="auth-submit-btn" type="submit" className="login-btn-primary" disabled={loading}>
                {loading ? (
                  <>
          ...
          <div style={{ display: "flex", alignItems: "center", margin: "22px 0 18px", gap: 12 }}>
            ...
            <span style={{ fontSize: ".75rem", color: "rgba(168,192,216,.4)", fontWeight: 500 }}>অথবা</span>
            <div style={{ flex: 1, height: 1, background: "rgba(255,255,255,.06)" }} />
          </div>
